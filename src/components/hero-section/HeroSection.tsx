...
const SocialMediaDrawer = ({ 
  ...
  return (
    <Sheet>
      <SheetTrigger>
        <div 
          className="p-2 rounded-full bg-white/5 border border-white/10 hover:border-white/30 transition-all cursor-pointer hover:translate-y-[-3px] hover:scale-110"
        >
          {icon}
        </div>
      </SheetTrigger>
              ...
              {type === 'instagram' ? (
                    ...
                    <div className="bg-white/10 rounded-lg overflow-hidden backdrop-blur-sm">
                      ...
                      <div className="p-3">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="text-white text-sm font-medium">omarsomoza1</span>
                        </div>
                        <p className="text-white/80 text-xs">
                          Transformando desafíos empresariales en soluciones digitales exitosas. #DigitalTransformation #Leadership
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white h-full overflow-y-auto">
                    ...
                    <div className="relative px-3">
                      ...
                      <div className="pt-10 pb-3">
                        <h3 className="text-black font-bold text-lg">Omar Somoza</h3>
                        <p className="text-gray-600 text-xs">Project Director & Technical Leader</p>
                        <p className="text-gray-500 text-xs">Founder at Avanzadi</p>
                        <div className="flex items-center text-gray-500 text-xs mt-1">
                          <span>Buenos Aires, Argentina</span>
                          <span className="mx-1">•</span>
                          <span className="text-[#0A66C2] font-medium">500+ connections</span>
                        </div>
                        
                        {/* Action buttons */}
                        <div className="flex gap-2 mt-3">
                          <div className="px-4 py-1 rounded bg-[#0A66C2] text-white text-xs font-medium">Connect</div>
                          <div className="px-4 py-1 rounded border border-[#0A66C2] text-[#0A66C2] text-xs font-medium">Message</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mt-2 px-3 py-2 border-t border-gray-200">
                      ...
                      <p className="text-gray-600 text-xs mt-1">
                        Project Director & Technical Leader with a solid background in digital transformation.
                        Expert in leading technical teams and delivering high-impact projects.
                      </p>
                    </div>
                    
                    {/* Experience */}
                    <div className="mt-2 px-3 py-2 border-t border-gray-200">
                      <h4 className="text-black font-bold text-sm">Experience</h4>
                      <div className="mt-2">
                        <div className="flex">
                          <div className="w-8 h-8 bg-gray-100 rounded flex-shrink-0"></div>
                          <div className="ml-2">
                            <p className="text-black font-medium text-xs">Founder</p>
                            <p className="text-gray-600 text-xs">Avanzadi</p>
                            <p className="text-gray-500 text-[10px]">2019 - Present</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="flex-1 overflow-hidden">
                  ...
                  <div className="h-12 bg-black flex items-center justify-between px-3 border-b border-white/10">
                    <span className="text-white font-medium text-lg">Avanzadi</span>
                    <div className="flex items-center space-x-4">
          ...
          >
            ...
            <div className="flex justify-center space-x-4 mb-8">
              ...
              <SocialMediaDrawer 
                ...
                icon={<span className="text-foreground/60 text-sm font-medium px-2">Avanzadi</span>}
                type="avanzadi"
              />
            </div>
          </motion.div>
